...
public class Controlador {
     ...
     * @throws MercatException 
     */
    public void guardar(String ruta) throws MercatException {
        this.dades.guardaDades(ruta);
    }
     ...
     * @throws MercatException 
     */
    public void carregar(String ruta) throws MercatException {
        Dades novesDades = Dades.carregaDades(ruta);
        if (novesDades != null) {
